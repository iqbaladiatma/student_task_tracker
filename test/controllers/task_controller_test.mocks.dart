...
// in student_task_tracker/test/controllers/task_controller_test.dart.
...
import 'package:student_task_tracker/model/task.dart' as _i4;
import 'package:student_task_tracker/services/storage_service.dart' as _i2;
...
class MockStorageService extends _i1.Mock implements _i2.StorageService {
  ...
  @override
  _i3.Future<void> toggleTaskStatus(String? taskId) => (super.noSuchMethod(
        Invocation.method(
          #toggleTaskStatus,
          [taskId],
        ),
